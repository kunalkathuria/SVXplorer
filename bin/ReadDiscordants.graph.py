...
WORK_DIR=sys.argv[15]
FILE1 = WORK_DIR + "/aln1s.bam" # read 1 discordants
FILE2 = WORK_DIR + "/aln2s.bam"# read 2 discordants
...
if __name__ == "__main__":
    ...
    #fp = open(WORK_DIR+"/DiscordFxnTimeLog.txt","w")
