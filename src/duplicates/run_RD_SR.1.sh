samtools view -h ${14} \
    ...
    | samtools view -Sb - \
    > /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim7/splitters.us.bam
#
samtools sort -n -@32 -o /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim7/splitters.ns.bam /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim7/splitters.us.bam
#samtools sort -n -@32 -o /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim2/$1 /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim2/us.$1
rm /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim7/splitters.us.bam
...
python add_SR_hash.2.py /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim7/splitters.ns.bam $2 $3 $4 ${13} ${12} ${10} ${18} ${21}
