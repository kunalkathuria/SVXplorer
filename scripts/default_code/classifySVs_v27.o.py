...
def compareCluster(cluster1, Clusters, Claimed, graph_c, graph_m, offset, LR, OCArray):
	...
	if Clusters[x].l_orient == 0 and Clusters[x].r_orient == 1 and Clusters[x].r_end - Clusters[x].l_start < MEAN_IL:
        ...
        elif sign2 and not sign3 and cluster1.r_orient != Clusters[x].l_orient and ((cluster1.l_orient != cluster1.r_orient) or (Clusters[x].l_orient != Clusters[x].r_orient) ):
        ...
        elif sign3 and not sign2 and cluster1.l_orient != Clusters[x].r_orient and ((cluster1.l_orient != cluster1.r_orient) or (Clusters[x].l_orient != Clusters[x].r_orient) ):
