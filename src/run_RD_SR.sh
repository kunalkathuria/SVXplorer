...
python WriteBed.py ../results/text/DisjSetCover_S.txt ${14} ${22} ${23}
cat ../results/text/deletions.bedpe ../results/text/tandemDuplications.bedpe ../results/text/inversions.bedpe ../results/text/insertions.bedpe > ../results/text/merged.bedpe
python ../scripts/bed2vcf.py ../results/text/merged.bedpe
python ../scripts/bed2vcf.py ../results/text/unknowns.bedpe
