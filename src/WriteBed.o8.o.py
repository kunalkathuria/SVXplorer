...
if __name__ == "__main__":
	...
	for line2 in f1:
		...
		if y[num] > 0:
			#$temporary        
			if line2_split[1]=="DEL_INS" and int(line2_split[7]) < int(line2_split[3]):       
			...
			if line2_split[1][0:3] == "TD" or (len(line2_split) > 2 and (line2_split[1][0:3] == "INV")): #or line2_split[1][0:3] == "DEL")):
				...
				if (0 < int(line2_split[10])-int(line2_split[6]) < INS_VAR_THRESH):
                                ...
                                if (0 < int(line2_split[10])-int(line2_split[6]) < INS_VAR_THRESH and 0 < int(line2_split[7])-int(line2_split[3]) < INS_VAR_THRESH) or (0 < int(line2_split[7])-int(line2_split[9]) < INS_VAR_THRESH and 0 < int(line2_split[4])-int(line2_split[6]) < INS_VAR_THRESH):
                                        continue
			...
			if line2_split[11].find("RD") == -1: 
				...
				elif len(line2_split[1]) > 4 and line2_split[11].find("PE") != -1 and line2_split[1][0:5] == "INS_C" and line2_split[8] != "-1":
