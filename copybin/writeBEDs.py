    ...
    with open(variantFile, 'r') as fAV:
        ...
        for counter, lineAV in enumerate(fAV):
            ...
            if svtype == "DEL":
                ...
                (svtype in ["INS", "INS_I", "INS_C_P", "INS_C_I_P"] and start3 != -1):

                out3 = "."
                if svtype in ["INS"]:
                    name = "BND"
                    output = [chrom1, start1, end1, chrom2, start2, end2]
                elif svtype in ["INS_C"] or \
                    svtype in ["INS_C_P"]:
                    ...
                    out1 = [chrom1, start1, end1, chrom2, start2, end2, 
                        ...
                        ".", GT, support, bnd, svtype, suppPE, suppSR, cl_support, ".", ".", GROUPID]
            ...
            elif False and svtype.startswith("INS"):
            ...
            if name != "DEL_2":
                ...
                out1[10], out2[10] = 'DEL', 'DEL'
                if svtype not in ["INS_C_P", "INS_C_I_P"]:
