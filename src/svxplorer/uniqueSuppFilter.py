...
def main():
    PARSER = argparse.ArgumentParser(
        description='Apply uniquenes Filter: pick variants having minimum unique support for each support category (SR, PE, MIXED)',
    ...
    PARSER.add_argument('allDiscordantsFile',
                        help='File containing all discordants with MQ,typically allDiscordants.txt')
