./varsecer -A 0 -B 32 -z /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim2/disc.sim100.all.bam -a ~/vsec/data/bams/sim2.stdev.50.cov.5.sorted.bam  -b ~/vsec/data/bams/sim2.stdev.50.cov.5.sorted.bam -r splitters.50.5.bam -C ../data/bed/ceph18.b37.exclude.2014-01-15.bed.webarchive -D ../results/text/ignoreCHR.txt -x ../results/text/sim2.final.cnv  1.0 -F 0 -m 0 -I /m/cphg-RLscratch/cphg-RLscratch/ar7jq/read_depth/NA12878/reference.map.bed
mv ../results/text/pe_results ../results/text/pe_results.R6
mv ../results/text/sr_results ../results/text/sr_results.R6
mkdir ../results/text/R6
mv ../results/text/*.bedpe ../results/text/R6
mv ../results/text/All_Discords_P_S.txt ../results/text/All_Discords_P_S.R6.txt
mv ../results/text/bam_stats.txt ../results/text/bam_stats.R6.txt
mv ../results/text/bindist.txt ../results/text/bindist.R6.txt
mv ../results/text/VariantMap_SR.txt ../results/text/VariantMap_SR.R6.txt
mv ../results/text/All_Variants_SR.txt ../results/text/All_Variants_SR.R6.txt

./varsecer -A 0 -B 32 -z /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim2/disc.sim100.all.bam -a ~/vsec/data/bams/sim2.stdev.50.cov.25.sorted.bam  -b ~/vsec/data/bams/sim2.stdev.50.cov.25.sorted.bam -r splitters.50.25.bam -C ../data/bed/ceph18.b37.exclude.2014-01-15.bed.webarchive -D ../results/text/ignoreCHR.txt -x ../results/text/sim2.final.cnv  1.0 -F 0 -m 0 -I /m/cphg-RLscratch/cphg-RLscratch/ar7jq/read_depth/NA12878/reference.map.bed
mv ../results/text/pe_results ../results/text/pe_results.R7
mv ../results/text/sr_results ../results/text/sr_results.R7
mkdir ../results/text/R7
mv ../results/text/*.bedpe ../results/text/R7
mv ../results/text/All_Discords_P_S.txt ../results/text/All_Discords_P_S.R7.txt
mv ../results/text/bam_stats.txt ../results/text/bam_stats.R7.txt
mv ../results/text/bindist.txt ../results/text/bindist.R7.txt
mv ../results/text/VariantMap_SR.txt ../results/text/VariantMap_SR.R7.txt
mv ../results/text/All_Variants_SR.txt ../results/text/All_Variants_SR.R7.txt
...
mv ../results/text/pe_results ../results/text/pe_results.R8
mv ../results/text/sr_results ../results/text/sr_results.R8
mkdir ../results/text/R8
mv ../results/text/*.bedpe ../results/text/R8
mv ../results/text/All_Discords_P_S.txt ../results/text/All_Discords_P_S.R8.txt
mv ../results/text/bam_stats.txt ../results/text/bam_stats.R8.txt
mv ../results/text/bindist.txt ../results/text/bindist.R8.txt
mv ../results/text/VariantMap_SR.txt ../results/text/VariantMap_SR.R8.txt
mv ../results/text/All_Variants_SR.txt ../results/text/All_Variants_SR.R8.txt

./varsecer -A 0 -B 32 -z /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim2/disc.sim100.all.bam -a ~/vsec/data/bams/sim2.stdev.5.cov.50.sorted.bam  -b ~/vsec/data/bams/sim2.stdev.5.cov.50.sorted.bam -r splitters.5.50.bam -C ../data/bed/ceph18.b37.exclude.2014-01-15.bed.webarchive -D ../results/text/ignoreCHR.txt -x ../results/text/sim2.final.cnv  1.0 -F 0 -m 0 -I /m/cphg-RLscratch/cphg-RLscratch/ar7jq/read_depth/NA12878/reference.map.bed
mv ../results/text/pe_results ../results/text/pe_results.R10
mv ../results/text/sr_results ../results/text/sr_results.R10
mkdir ../results/text/R10
mv ../results/text/*.bedpe ../results/text/R10
mv ../results/text/All_Discords_P_S.txt ../results/text/All_Discords_P_S.R10.txt
mv ../results/text/bam_stats.txt ../results/text/bam_stats.R10.txt
mv ../results/text/bindist.txt ../results/text/bindist.R10.txt
mv ../results/text/VariantMap_SR.txt ../results/text/VariantMap_SR.R10.txt
mv ../results/text/All_Variants_SR.txt ../results/text/All_Variants_SR.R10.txt

./varsecer -A 0 -B 32 -z /m/cphg-RLscratch2/cphg_ratan/kk7t/target/sim2/disc.sim100.all.bam -a ~/vsec/data/bams/sim2.stdev.25.cov.50.sorted.bam  -b ~/vsec/data/bams/sim2.stdev.25.cov.50.sorted.bam -r splitters.25.50.bam -C ../data/bed/ceph18.b37.exclude.2014-01-15.bed.webarchive -D ../results/text/ignoreCHR.txt -x ../results/text/sim2.final.cnv  1.0 -F 0 -m 0 -I /m/cphg-RLscratch/cphg-RLscratch/ar7jq/read_depth/NA12878/reference.map.bed
mv ../results/text/pe_results ../results/text/pe_results.R9
mv ../results/text/sr_results ../results/text/sr_results.R9
mkdir ../results/text/R9
mv ../results/text/*.bedpe ../results/text/R9
mv ../results/text/All_Discords_P_S.txt ../results/text/All_Discords_P_S.R9.txt
mv ../results/text/bam_stats.txt ../results/text/bam_stats.R9.txt
mv ../results/text/bindist.txt ../results/text/bindist.R9.txt
mv ../results/text/VariantMap_SR.txt ../results/text/VariantMap_SR.R9.txt
mv ../results/text/All_Variants_SR.txt ../results/text/All_Variants_SR.R9.txt
