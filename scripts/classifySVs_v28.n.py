...
##                continue
        ...
        # Large insertions
          ...
          if cluster1.ltid == Clusters[x].ltid or cluster1.ltid == cluster1.rtid or Clusters[x].ltid == cluster1.rtid:
            ...
            if cluster1.l_orient == cluster1.r_orient and Clusters[x].r_orient == Clusters[x].l_orient:
                    type_O = "INS_I"
...
##            graph_c.add_edge(cl1,connection,1)
        ...
        if elem.typeO == "TD_I":
            ...
            elif (elem.typeO == "INS_C_P" or elem.typeO == "INS_C_I_P") and and cloc1_tid == elem.bp1tid and cloc2_tid == elem.bp3tid and elem.bp1_orient != -1 and elem.bp2_orient != -1 and isOverlapping("V",cluster1,elem,"L1") and cluster1.l_orient != elem.bp1_orient and isOverlapping("V",cluster1,elem,"R3") and cluster1.r_orient != elem.bp3_orient:
