...
def markDuplicateClusterRegions(clusterFile, wdir):
    ...
    for line in fCL:
        ...
        orient = line_split[2]
        if orient == "01":
            list01 = separateClusters(line, "L", badRegFile, list01, chr_n, start, chr_prev01, prev_stop01, chrB,
                                      chrB_prev01)
            chr_prev01, prev_stop01, chrB_prev01 = chr_n, int(line_split[5]), chrB
        elif orient == "10":
            list10 = separateClusters(line, "L", badRegFile, list10, chr_n, start, chr_prev10, prev_stop10, chrB,
                                      chrB_prev10)
            chr_prev10, prev_stop10, chrB_prev10 = chr_n, int(line_split[5]), chrB
        elif orient == "00":
            list00 = separateClusters(line, "L", badRegFile, list00, chr_n, start, chr_prev00, prev_stop00, chrB,
                                      chrB_prev00)
            chr_prev00, prev_stop00, chrB_prev00 = chr_n, int(line_split[5]), chrB
        elif orient == "11":
            list11 = separateClusters(line, "L", badRegFile, list11, chr_n, start, chr_prev11, prev_stop11, chrB,
                                      chrB_prev11)
    ...
    data = pd.read_table(clusterFile,
                         ...
                         dtype={'lchr': np.str, 'rchr': np.str,
                                'orient': np.str})  # TODO: change to read_csv or suppress deprecation warning
    ...
    for line in fCNR:
        ...
        orient = line_split[2]
        if orient == "01":
            list01 = separateClusters(line, "R", badRegFile, list01, chr_n, start, chr_prev01, prev_stop01, chrB,
                                      chrB_prev01)
            chr_prev01, prev_stop01, chrB_prev01 = chr_n, int(line_split[8]), chrB
        elif orient == "10":
            list10 = separateClusters(line, "R", badRegFile, list10, chr_n, start, chr_prev10, prev_stop10, chrB,
                                      chrB_prev10)
            chr_prev10, prev_stop10, chrB_prev10 = chr_n, int(line_split[8]), chrB
        elif orient == "00":
            list00 = separateClusters(line, "R", badRegFile, list00, chr_n, start, chr_prev00, prev_stop00, chrB,
                                      chrB_prev00)
            chr_prev00, prev_stop00, chrB_prev00 = chr_n, int(line_split[8]), chrB
        elif orient == "11":
            list11 = separateClusters(line, "R", badRegFile, list11, chr_n, start, chr_prev11, prev_stop11, chrB,
                                      chrB_prev11)
