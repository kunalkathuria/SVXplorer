...
if __name__ == "__main__":
	...
	varType = -1
		...
		sr_bp2_tid = sr2.reference_name
                ...
                if sr1.mapping_quality < MAP_THRESH or sr2.mapping_quality < MAP_THRESH or (sr_bp1_tid == bp1_cons_tid and sr_bp2_tid == bp2_cons_tid and abs(sr_bp1 - bp1_cons) < SR_MARGIN and abs(sr_bp2 - bp2_cons) < SR_MARGIN):
	...
	if match:
		...
		#$add claimed variable
			...
			#tester.tid = "1"
			#tester.tid_2 = "1"
			#print "Is it in?", tester in SRVarHash, SRFrag
